	  ...
	  <IpadMint />
    		...
    		<div className={styles.homepageTradeSubpage}>
      			...
      			<div className={styles.wrapper}>
        				<div  style={secondFont.style} className={styles.div}>128.68</div>
      			</div>
...
<Minting />
      			...
      			<div className={styles.rectangleParent}>
        				...
        				<div className={styles.maskGroupParent}>
          					...
          					<div className={styles.mediaInquiresForCmaxContParent}>
            						...
            						<div style={secondFont.style}  className={styles.copyRight20231}>{t("copyright")}</div>
          					</div>
				...
				<Navbar />
      			...
      			<div className={styles.homeParent}>
        				...
        				<div style={fourthFont.style} className={styles.trade1}><a href='/mint'>
