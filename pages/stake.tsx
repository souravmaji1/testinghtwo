    		...
    		<div className={styles.homepageStake}>
				...
				<Navbar />
      			...
      			<div className={styles.homeParent}>
        				...
        				<div style={fourthFont.style} className={styles.stake1}><a href='/stake'>
						<Image style={{width:'54px'}}    src={Stakes} alt='' />
							</a></div>
        				<div style={fourthFont.style} className={styles.home} onClick={onAboutText1Click}><a href='/about'>
        ...
        <Languageswitch />
      			...
      			<div className={styles.frameParent}>
        				<div className={styles.groupParent} onClick={openToolTip}>
          					...
          					<div style={secondFont.style} className={styles.search}>{t("earningrewards")}  </div>
        				</div>
        				...
        				<div className={styles.frameDiv} onClick={openToolTip2}>
          					...
          					<div style={secondFont.style} className={styles.search}>{t("token")}  </div>
        				</div>
        				<div className={styles.groupGroup}>
          					<Image className={styles.groupIcon2} alt="" src={Fourth} />
          					<div style={secondFont.style} className={styles.search}>{t("liquidity")}  </div>
        				</div>
      			</div>
      			...
      			<div className={styles.frameParent1}>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>1G</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>1M</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>3M</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div  style={thirdFont.style} className={styles.trade}>6M</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>1A</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>3A</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>5A</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>YTD</div>
        				</div>
        				<div className={styles.maxWrapper}>
          					<div style={thirdFont.style}  className={styles.trade}>MAX</div>
        				</div>
      			</div>
      			...
      			<div className={styles.stakingStatsParent}>
        				...
        				<div style={thirdFont.style} className={styles.topHolders}>{t("topholders")}  </div>
        				...
        				<div  style={secondFont.style}   className={styles.div}>2,337,786</div>
        				<div style={secondFont.style}   className={styles.div1}>2,337,786</div>
        				<div style={secondFont.style}   className={styles.div2}>2,337,786</div>
        				<div style={secondFont.style}  className={styles.div3}>2,337,786</div>
        				...
        				<div className={styles.frameParent2}>
          					<div className={styles.wrapper}>
            						<b style={thirdFont.style}   className={styles.search}>1</b>
          					</div>
          					<div  style={secondFont.style}  className={styles.div5}>09324414</div>
        				</div>
        				<div className={styles.frameParent3}>
          					<div className={styles.container}>
            						<b  style={thirdFont.style} className={styles.search}>2</b>
          					</div>
          					<div style={secondFont.style}  className={styles.div6}>09324414</div>
        				</div>
        				<div className={styles.frameParent4}>
          					<div className={styles.container}>
            						<b style={thirdFont.style}   className={styles.search}>3</b>
          					</div>
          					<div style={secondFont.style}   className={styles.div6}>09324414</div>
        				</div>
        				<div className={styles.frameParent5}>
          					<div className={styles.container}>
            						<b  style={thirdFont.style}  className={styles.search}>4</b>
          					</div>
          					<div style={secondFont.style}  className={styles.div6}>09324414</div>
        				</div>
      			...
      			<div className={styles.stakingStatsParent}>
        				...
        				<img className={styles.groupChild3} alt="" src="Vector 17.svg" />
        				<img className={styles.groupChild4} alt="" src="Vector 18.svg" />
        				<div  style={secondFont.style}  className={styles.div9}>2,337,786</div>
        				<div style={secondFont.style}   className={styles.div1}>2,337,786</div>
        				<div style={secondFont.style}    className={styles.div11}>2,337,786</div>
        				<div style={secondFont.style}   className={styles.div3}>2,337,786</div>
        				...
        				<div className={styles.frameParent2}>
          					...
          					<div style={secondFont.style}  className={styles.div14}>09324414</div>
        				</div>
        				<div className={styles.frameParent3}>
          					<div className={styles.container}>
            						<b  style={thirdFont.style}  className={styles.search}>2</b>
          					</div>
          					<div style={secondFont.style}    className={styles.div15}>09324414</div>
        				</div>
        				<div className={styles.frameParent4}>
          					<div className={styles.container}>
            						<b style={thirdFont.style}  className={styles.search}>3</b>
