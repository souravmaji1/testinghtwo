    		...
    		<div className={styles.homepageProfile}>
				...
				<Navbar />
      			...
      			<div className={styles.homeParent}>
        				<div style={{fontFamily:'Inter'}}  className={styles.home} ><a href='/'>
						<Image style={{width:'54px'}}    src={Homei} alt='' />
							</a></div>
        				<div style={{fontFamily:'Inter'}}  className={styles.home}><a href='/trade'>
						<Image style={{width:'54px'}}    src={Trades} alt='' />
							</a></div>
        				<div style={{fontFamily:'Inter'}}  className={styles.home} ><a href='/stake'>
						<Image style={{width:'54px'}}    src={Stakes} alt='' />
							</a></div>
						<div style={{fontFamily:'Inter'}}  className={styles.home}><a href='/about'>
