  	...
  	return (<>
    		<div className={styles.stakeIpadPro1292}>
      			...
      			<div className={styles.homeParent}>
        				...
        				<div style={fourthFont.style}   className={styles.stake} ><a href='/stake'>
				...
				<Image src={StakingBene} alt='' />
      			...
      			<div className={styles.frameParent}>
        				<div className={styles.groupParent} onClick={openToolTip}>
          					...
          					<div style={secondFont.style}   className={styles.home}>  {t("earningreward")}  </div>
        				</div>
        				...
        				<div className={styles.groupParent} onClick={openToolTip2}>
          					...
          					<div style={secondFont.style}   className={styles.home}> {t("token")}  </div>
        				</div>
        				<div className={styles.groupParent} onClick={openToolTip3}>
          					<Image className={styles.groupIcon1} alt="" src={Fourth} />
          					<div style={secondFont.style}   className={styles.home}>  {t("liquidity")}  </div>
        				</div>
      			</div>
      			...
      			<div className={styles.frameParent1}>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>1G</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>1M</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>3M</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>6M</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>1A</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>3A</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>5A</div>
        				</div>
        				<div className={styles.gWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>YTD</div>
        				</div>
        				<div className={styles.maxWrapper}>
          					<div style={thirdFont.style}  className={styles.g}>MAX</div>
        				</div>
      			</div>
        				...
        				<div className={styles.frameParent2}>
          					<div className={styles.rectangleGroup}>
            						...
            						<div className={styles.frameParent3}>
              							...
              							<div style={secondFont.style}  className={styles.div}>09324414</div>
            						</div>
            						...
            						<div style={secondFont.style}   className={styles.div4}>2,337,786</div>
