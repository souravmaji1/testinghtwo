    		...
    		<div className={styles.tradeSubpageIpadPro129}>
				...
				<LanguageSelector />
      			...
      			<div className={styles.aboutParent} onClick={openMenuIPadPro1291}>
        				<div style={secondFont.style}  className={styles.g}>
							<Image src={Menus} alt='' />
						</div>
      			...
      			<div className={styles.frameParent2}>
        				<div className={styles.frameParent3}>
          					<div className={styles.wrapper}>
            						<div style={secondFont.style}  className={styles.trade}>128.68</div>
          					</div>
          					<div className={styles.vectorParent}>
            						<img className={styles.vectorIcon1} alt="" src="Vector.svg" />
            						<div style={secondFont.style}  className={styles.trade}>+1,03  | +0,83%</div>
          					</div>
        				</div>
