  	...
  	return (
    		<div className={styles.aboutIpadPro1293}>
      			...
      			<div className={styles.homeParent}>
        				...
        				<div style={fourthFont.style}   className={styles.about} ><a href='/about'>
        ...
        <Languageswitch />
				  ...
				  <ConnectWallet
						...
						style={{textTransform:'uppercase',background:'none',fontWeight:'500',fontFamily:'__thirdFont_3ea4f2',border:'none',color:'black',fontSize:'12px'}}
						/>
				...
				<Image src={Aboutu} alt='' />
      			...
      			<div className={styles.vectorParent}>
        				...
        				<div className={styles.distributionTokenCbcContainer}>
          					<p style={thirdFont.style}  className={styles.blankLine}>  {t("roadmapone")}  </p>
          					
        				</div>
        				<div className={styles.distributionTokenCbcContainer1}>
          					<p style={thirdFont.style}   className={styles.blankLine}> {t("roadmapfour")}  </p>
          					
        				</div>
        				<div className={styles.distributionTokenCbcContainer2}>
          					<p style={thirdFont.style}   className={styles.blankLine}> {t("roadmapthree")}  </p>
          				
        				</div>
        				<div className={styles.distributionTokenCbcContainer3}>
          					<p style={thirdFont.style}  className={styles.blankLine}>  {t("roadmaptwo")}  </p>
