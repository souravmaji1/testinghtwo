...
const HomeIPadPro1291: NextPage = () => {
  ...
  return (
    <div className={`${styles.homeIpadPro1291}`}>
      ...
      <section className="h-fit w-screen bg-center bg-cover flex flex-col items-center justify-center bg-no-repeat mt-20 absolute bottom-[350px] landscape:bottom-[500px] z-50 opacity-100">
        <img
          src={communityBg.src}
