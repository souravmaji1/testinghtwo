				...
				<LanguageSelector />
      			...
      			<div className={styles.btnParent}>
        				<div className={styles.btn}>
          					...
          					<div style={thirdFont.style}  className={styles.startTrading}><a href='/trade'>
      			...
      			<div className={styles.ellipseParent}>
					...
					<Image className={styles.mingcutewallet4FillIcon1} alt="" src={Download} />
          					<div style={thirdFont.style}  className={styles.downloadWhitepaper}><a href='https://moodglobalservices.notion.site/Coliseum-White-Paper-fa2c3eb3583b454a8a4d7ad8d4360391?pvs=4'> 
      			...
      			<div className={styles.treasuryTokensEcosystemParent}>
        				...
        				<div className={styles.ellipseContainer}>
          					...
          					<div className={styles.rectangleParent1}>
            						...
            						<div style={secondFont.style}  className={styles.joinAPlatform1}> {t("benefitparagraphtwo")}  </div>
        				...
        				<div className={styles.rectangleParent3}>
							  ...
							  <div  style={fourthFont.style}  className={styles.trade}>
										< a href="/"><Image src={Homer} alt='' />  </a>
									</div>
            						<div  style={fourthFont.style}  className={styles.trade}>
										< a href="/trade"><Image src={Tradei} alt='' />  </a>
									</div>
            						<div  style={fourthFont.style}  className={styles.trade}>
									< a href="/stake"><Image src={Stakei} alt='' />  </a>
									</div>
            						<div  style={fourthFont.style}  className={styles.trade}>
									< a href="/about"><Image src={Abouti} alt='' />  </a>
									</div>
