...
export default function Minting() {
  ...
  <TabList className={styles.swapMintburnItem} sx={{padding:'10px 20px 10px 20px'}}   >
    <Tab style={thirdFont.style}   sx={{height:'54px',padding:'10px 50px 10px 50px',borderRadius:'7px'}}    _selected={{ color: 'black', bg: 'yellow' }}>
		<Image src={Swa} alt='' />
	</Tab>
    <Tab style={thirdFont.style}  className={styles.swapMintburnChild2}   sx={{height:'54px',padding:'10px 18px 10px 31px',borderRadius:'7px'}}    _selected={{ color: 'black', bg: 'yellow' }}   >
  <Image src={Mb} alt='' />
...
<PriceView />
  ...
  <TabList>
    <Tab style={thirdFont.style}    className={styles.mint} _selected={{ color: 'yellow', bg: 'none' }}>
		<Image src={Mx} alt='' />
	</Tab>
    <Tab style={thirdFont.style}    className={styles.burn}    _selected={{ color: 'yellow', bg: 'none' }}>
		<Image src={Br} alt='' />
	</Tab>
  </TabList>
  <TabPanels>
      ...
      />
        				...
        				<div className={styles.frameGroup}>
          					<div className={styles.ellipseParent}>
            						...
            						<div style={{fontFamily:"Inter"}}  className={styles.g}>usdc</div>
          					</div>
      ...
      />
        				...
        				<div className={styles.frameGroup}>
          					<div className={styles.ellipseParent}>
            						...
            						<div style={{fontFamily:"Inter"}}  className={styles.g}>tita</div>
          					</div>
