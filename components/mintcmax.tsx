...
export default function Minting() {
	...
	const { contract: requestTokenContract } = useContract("0xcee91e93E147553563A74fb8aD6BECefF227C948");
  ...
  <TabList className={styles.swapMintburnItem} sx={{padding:'10px 20px 10px 20px'}}   >
    <Tab style={{fontFamily:"__secondFont_72e69f",fontWeight:"bold"}}   sx={{height:'54px',padding:'10px 50px 10px 50px',borderRadius:'7px',margin:'auto',fontSize:"29px"}}    _selected={{ color: 'black', bg: 'yellow' }}>Buy CMAX</Tab>
  ...
  <TabPanels>
    ...
    <div className={styles.swapMintburnInner} />
        				...
        				<div className={styles.antDesignswapOutlined}>
          					<div style={{fontFamily:'__fourthFont_9c16a8'}} className={styles.max1}>max</div>
        				</div>
	...
	<Button style={{textTransform:'none',fontFamily:'__fourthFont_9c16a8',fontSize:'21px'}}     sx={{color:'black'}}  onClick={handleClickOpen}>
        Buy Using Cards
      </Button>
	...
	<Image className={styles.frameChild11} src={CommitLogo} alt={CommitLogo} />		
      ...
      <div className={styles.swapMintburnChild2} />
        				...
        				<div style={{fontFamily:"__secondFont_72e69f"}}  className={styles.youPay}>you pay</div>
        			
        				
        				
        				<div className={styles.frameDiv} />
        				<div  style={{fontFamily:"__secondFont_72e69f"}}   className={styles.balance323400}>balance: $0</div>
        				<div style={{fontFamily:"__secondFont_72e69f"}}   className={styles.expectedPrice124681}>Expected Price: $124.68</div>
        				...
        				<div style={{fontFamily:"__secondFont_72e69f"}}    className={styles.div5}>$
      ...
      />
        				...
        				<div className={styles.frameGroup}>
          					<div className={styles.ellipseParent}>
            						...
            						<div style={{fontFamily:"__secondFont_72e69f"}}   className={styles.g}>USDC</div>
          					</div>
